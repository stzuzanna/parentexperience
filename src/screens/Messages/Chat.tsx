              ...
              {message.sender !== 'sandra' && (
                <div className="flex items-center gap-2">
                  <Avatar className="w-8 h-8">
                    <AvatarImage 
                      src={message.avatar || (message.sender === 'olivia' ? "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=400" : "/avatar-2.png")} 
